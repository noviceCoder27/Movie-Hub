...
var requireAuth = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var authorization, token, secret, idObj, _id, user;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                if (!(token && token !== "null")) return [3 /*break*/, 4];
                secret = process.env.SECRET;
                idObj = jsonwebtoken_1["default"].verify(token, secret);
                if (!(typeof idObj !== "string")) return [3 /*break*/, 2];
                _id = idObj._id;
